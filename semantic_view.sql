...
CREATE OR REPLACE SEMANTIC VIEW MESHTASTIC_SEMANTIC_VIEW
  COMMENT = 'Semantic view for Meshtastic mesh network IoT data analysis'
  TABLES (
...
COMMENT ON SEMANTIC VIEW MESHTASTIC_SEMANTIC_VIEW IS 
  'Meshtastic mesh network data including GPS positions, device telemetry (battery, temperature, humidity), 
   text messages, and LoRa signal quality metrics from devices like SenseCAP Card Tracker T1000-E';
